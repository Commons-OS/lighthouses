...
tags:
  ...
  - b-corp
sources:
  - title: "Patagonia Official Website"
    url: "https://www.patagonia.com/"
  - title: "Let My People Go Surfing - Yvon Chouinard"
    url: "https://www.patagonia.com/product/let-my-people-go-surfing-revised-paperback-book/BK067.html"
...
### Purpose-Driven Business
Patagonia's mission statement evolved from "Build the best product" to "We're in business to save our home planet." Every decision is filtered through this purpose.

### Radical Transparency
The company publishes detailed information about its supply chain, environmental footprint, and challenges. The "Footprint Chronicles" allows customers to trace products back to their origins.
...
### Environmental Activism
The company actively campaigns for environmental causes, sues the government over public lands, and encourages customers to "Don't Buy This Jacket" (a famous Black Friday ad urging reduced consumption).
...
> "I never wanted to be a businessman. But I've learned that business can be a force for good. Now, instead of extracting value from nature and transforming it into wealth, we're using the wealth Patagonia creates to protect the source of all wealth."
> 
